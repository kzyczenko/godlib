...
**************************************************************************************
	...
	XDEF	_System_SaveVectors
	XDEF	_System_RestoreVectors
	XDEF	_System_SetIML
	XDEF	_System_GetIML
	XDEF	_System_SetDataCache030
	XDEF	_System_SetDataCache060
	XDEF	_System_SetInstructionCache030
	XDEF	_System_SetInstructionCache060
	XDEF	_System_HblTemp
	XDEF	_System_200hzTemp

	XDEF	_System_GetEmuName0
	XDEF	_System_GetEmuName1
	XDEF	_System_GetpEmuDescLL

	XDEF	_gSystemHblTempCounter
	XDEF	_gSystem200hzTempCounter
...
_System_SetInstructionCache030:
	rts
...
_System_SetInstructionCache060:
	tst.w	d0
	beq.s	.cache060_off
...
_System_HblTemp:
	addq.l	#1,_gSystemHblTempCounter
	rte
...
_System_200hzTemp:
	addq.l	#1,_gSystem200hzTempCounter
	bclr.b	#4,$FFFFFA11
	rte
...
_gSystemHblTempCounter:		dc.l	0
_gSystem200hzTempCounter:	dc.l	0