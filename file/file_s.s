...
**************************************************************************************
	...
	XDEF	_File_FileSelectorAES

	XREF	_gpGemDosStackUser
...
*------------------------------------------------------------------------------------*
* FUNCTION : _File_FileSelectorAES( const char * apTitle, const char * apPath, const char * apFile )
* ACTION   : calls file selector
* CREATION : 11.01.08 PNK
*------------------------------------------------------------------------------------*

_File_FileSelectorAES:
