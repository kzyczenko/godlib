...
**************************************************************************************
	...
	XDEF	_RleSprite_Draw
	XDEF	_RleSprite_DrawClipY
	XDEF	_RleSprite_DrawClip
...
*------------------------------------------------------------------------------------*
* FUNCTION : _RleSprite_Draw( const sRleSprite * apSprite,U16 * apScreen,U32 aScreenWidth )
* ACTION   : _RleSprite_Draw
...
*------------------------------------------------------------------------------------*
* FUNCTION : _RleSprite_Draw( const sRleSprite * apSprite,U16 * apScreen,U32 aScreenWidth, U32 aSprHeight, U32 aSprY0 )
* ACTION   : _RleSprite_Draw
* CREATION : 10.04.2005 PNK
*------------------------------------------------------------------------------------*

_RleSprite_DrawClipY:
	sub.w	sRleSprite_mWidth(a0),d0		; offset to next line
	ext.l	d0								; as long
	add.l	d0,d0							; * pixel size
	move.l	sRleSprite_mpLines(a0),a0		; ptr to first line of data
...
*------------------------------------------------------------------------------------*
* FUNCTION : _RleSprite_DrawClip( const sRleSprite * apSprite,U16 * apScreen,U32 aScreenWidth,sSpriteRect * apRect )
* ACTION   : _RleSprite_DrawClip
* CREATION : 10.04.2005 PNK
*------------------------------------------------------------------------------------*
