...
**************************************************************************************
	...
	XDEF	_Except_Handler68000
	XDEF	_Except_Handler68030

	XDEF	_Except_Crash

	XDEF	_gExcept_HandlersTable
...
**************************************************************************************
	...
	move.w	#$2700,sr
	move.w	#aNum,_gExceptInfo+sExceptInfo_Type
	bra		_Except_Handler68000
...
*------------------------------------------------------------------------------------*
* FUNCTION : _Except_Handler68000
* ACTION   : 68000 except handler
* CREATION : 17.11.01 PNK
*------------------------------------------------------------------------------------*

_Except_Handler68000:
	...
	move.l	d0,_gExceptInfo+sExceptInfo_Dreg+(0*4)
	move.l	d1,_gExceptInfo+sExceptInfo_Dreg+(1*4)
	move.l	d2,_gExceptInfo+sExceptInfo_Dreg+(2*4)
	move.l	d3,_gExceptInfo+sExceptInfo_Dreg+(3*4)
	move.l	d4,_gExceptInfo+sExceptInfo_Dreg+(4*4)
	move.l	d5,_gExceptInfo+sExceptInfo_Dreg+(5*4)
	move.l	d6,_gExceptInfo+sExceptInfo_Dreg+(6*4)
	move.l	d7,_gExceptInfo+sExceptInfo_Dreg+(7*4)

	move.l	a0,_gExceptInfo+sExceptInfo_Areg+(0*4)
	move.l	a1,_gExceptInfo+sExceptInfo_Areg+(1*4)
	move.l	a2,_gExceptInfo+sExceptInfo_Areg+(2*4)
	move.l	a3,_gExceptInfo+sExceptInfo_Areg+(3*4)
	move.l	a4,_gExceptInfo+sExceptInfo_Areg+(4*4)
	move.l	a5,_gExceptInfo+sExceptInfo_Areg+(5*4)
	move.l	a6,_gExceptInfo+sExceptInfo_Areg+(6*4)
	move.l	a7,_gExceptInfo+sExceptInfo_Areg+(7*4)

	move.w	0(a7),_gExceptInfo+sExceptInfo_SR
	move.l	2(a7),_gExceptInfo+sExceptInfo_PC
...
*------------------------------------------------------------------------------------*
* FUNCTION : _Except_Handler68030
* ACTION   : 68000 except handler
* CREATION : 17.11.01 PNK
*------------------------------------------------------------------------------------*

_Except_Handler68030:
	...
	lsr.w	#2,d0
	andi.w	#63,d0
	move.w	d0,_gExceptInfo+sExceptInfo_Type
