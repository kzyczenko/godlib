...
**************************************************************************************
	...
	XDEF	_Video_SaveRegsST
	XDEF	_Video_RestoreRegsST
	XDEF	_Video_SaveRegsSTE
	XDEF	_Video_RestoreRegsSTE
	XDEF	_Video_SaveRegsTT
	XDEF	_Video_RestoreRegsTT
	XDEF	_Video_SaveRegsFalcon
	XDEF	_Video_RestoreRegsFalcon

	XDEF	_Video_UpdateRegsST
	XDEF	_Video_UpdateRegsSTE
	XDEF	_Video_UpdateRegsTT
	XDEF	_Video_UpdateRegsFalcon

	XDEF	_Video_GetPalST
	XDEF	_Video_SetPalST
	XDEF	_Video_GetPalTT
	XDEF	_Video_SetPalTT
	XDEF	_Video_GetPalFalcon
	XDEF	_Video_SetPalFalcon

	XDEF	_Video_XbiosSetScreen
	XDEF	_Video_XbiosFalconSetLow

	XDEF	_Video_SetFalconSTLowVGA
	XDEF	_Video_SetFalconSTLowRGBPAL_W
	XDEF	_Video_SetFalconSTLowRGBNTSC_W
	XDEF	_Video_SetFalconSTLowRGBPAL
	XDEF	_Video_SetFalconSTLowRGBNTSC

	XDEF	_Video_SetFalconTC50RGB
	XDEF	_Video_SetFalconTC60RGB
	XDEF	_Video_SetFalconTC50VGA
	XDEF	_Video_SetFalconTC60VGA
...
_Video_UpdateRegsST:
	...
	lea		_gVideo,a0						; address of video struct
...
_Video_SetFalconTC50VGA:
	move.w	#0,monitor
	move.w	#60,vga_freq
	lea.l	_gVidelData+36*4*4,a0			;320*240 16bit
	bra		setvideo				;
_Video_SetFalconTC60VGA:
	move.w	#0,monitor
	move.w	#60,vga_freq
	lea.l	_gVidelData+36*4*4,a0			;320*240 16bit
	bra		setvideo				;
_Video_SetFalconTC50RGB:
	move.w	#1,monitor
	move.w	#50,rgb_freq
	lea.l	_gVidelData+36*4*4,a0			;320*240 16bit
	bra		setvideo				;
_Video_SetFalconTC60RGB:
	move.w	#1,monitor
	move.w	#60,rgb_freq
	lea.l	_gVidelData+36*4*4,a0			;320*240 16bit
	bra		setvideo				;
...
video_1:
	lea.l	_gVidelData+36*4*0,a0			;144/288*100 16bit
	bra.s	setvideo				;

video_2:
	lea.l	_gVidelData+36*4*1,a0			;288*200 16bit
	bra.s	setvideo				;

video_3:
	lea.l	_gVidelData+36*4*2,a0			;288*200 8bit
	bra.s	setvideo				;

video_4:
	lea.l	_gVidelData+36*4*3,a0			;576*400 8bit
	bra.s	setvideo				;
...
video_6:
	lea.l	_gVidelData+36*4*5,a0			;320*240 8bit
	bra.s	setvideo				;

video_7:
	lea.l	_gVidelData+36*4*6,a0			;640*480 8bit
...
_Video_SetFalconSTLowRGBNTSC_W:
	move.w	sr,-(a7)
	move.w	#$2700,sr
