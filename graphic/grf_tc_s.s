...
**************************************************************************************
	...
	XDEF	_Graphic_TC_Blit
	XDEF	_Graphic_TC_ClearScreen
	XDEF	_Graphic_TC_CopyScreen
	XDEF	_Graphic_TC_DrawBox
	XDEF	_Graphic_TC_DrawLine
	XDEF	_Graphic_TC_DrawPixel
	XDEF	_Graphic_TC_DrawSprite
	XDEF	_Graphic_TC_DrawTri
	XDEF	_Graphic_TC_DrawQuad

	XDEF	_Graphic_TC_Blit_Clip
	XDEF	_Graphic_TC_ClearScreen_Clip
	XDEF	_Graphic_TC_CopyScreen_Clip
	XDEF	_Graphic_TC_DrawBox_Clip
	XDEF	_Graphic_TC_DrawLine_Clip
	XDEF	_Graphic_TC_DrawPixel_Clip
	XDEF	_Graphic_TC_DrawSprite_Clip
	XDEF	_Graphic_TC_DrawTri_Clip
	XDEF	_Graphic_TC_DrawQuad_Clip

	XDEF	_gGraphicBlitRout
...
.y1_ok:
	...
	bra		_Graphic_TC_Blit_Go				; Blit it
...
_Graphic_TC_CopyScreen:
	movem.l	d3-d7/a2-a6,-(a7)							; save regs

	cmp.w	#320,sGraphicCanvas_Width(a0)
	bne		_Graphic_TC_CopyScreen_Gen
	cmp.w	#240,sGraphicCanvas_Height(a0)
	bne		_Graphic_TC_CopyScreen_Gen
...
.y1_ok:
	...
	bra		_Graphic_TC_DrawBox_Go				; Render box
...
_Graphic_TC_DrawPixel_Clip:
	...
	bra		_Graphic_TC_DrawPixel_Go			; Draw Pixel
...
_Graphic_TC_DrawPixel:

	move.w	sGraphicPos_X(a1),d1				; Pixel X
	move.w	sGraphicPos_Y(a1),d2				; Pixel Y

_Graphic_TC_DrawPixel_Go:
